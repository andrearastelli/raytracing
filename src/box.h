...
Box::Box(const Vec3 &p0, const Vec3 &p1, Material *ptr)
{
    ...
    list[i++] = new FlipNormals(new XY_Rect(p0.x(), p1.x(), p0.y(), p1.y(), p1.z(), ptr));

    list[i++] =                 new XZ_Rect(p0.x(), p1.x(), p0.z(), p1.z(), p1.y(), ptr);
    list[i++] = new FlipNormals(new XZ_Rect(p0.x(), p1.x(), p0.z(), p1.z(), p1.y(), ptr));

    list[i++] =                 new YZ_Rect(p0.y(), p1.y(), p0.z(), p1.z(), p1.x(), ptr);
    list[i++] = new FlipNormals(new YZ_Rect(p0.y(), p1.y(), p0.z(), p1.z(), p1.x(), ptr));
